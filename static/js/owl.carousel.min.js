...
},a.fn.owlCarousel.Constructor.Plugins.Animat/**
 * Owl Carousel v2.3.4
...
;(function($, window, document, undefined) {
	...
	Owl.Workers = [ {
		...
		run: function() {
			...
			this.$stage.children(':eq(' + matches.join('), :eq(') + ')').attr("aria-label", "Próximo");
...
;(function($, window, document, undefined) {
	...
	Navigation.Defaults = {
		...
		navSpeed: false,
		navElement: 'button aria-label="Próxima Apresentação" type="button" role="presentation"',
		navContainer: false,
	...
	Navigation.prototype.initialize = function() {
		...
		if (!settings.dotsData) {
			this._templates = [ $('<button aria-label="Próxima Apresentação" role="button">')
	...
	Navigation.prototype.draw = function() {
		...
		if (settings.dots) {
			...
			this._controls.$absolute.find('.active').attr("aria-label", "Atual");
			this._controls.$absolute.children().eq($.inArray(this.current(), this._pages)).attr("aria-label", "Próximo");
		}
	};
